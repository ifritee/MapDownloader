...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        QMapControl(QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
         ...
         * @param window_flags QWidget window flags.
         */
        QMapControl(const QSizeF& size_px, QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
